...
abstract class $ProfileStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ProfileModel? profileModel, Status? status, String? error});
}
...
class _$ProfileStateImpl implements _ProfileState {
  const _$ProfileStateImpl({this.profileModel, this.status, this.error});
  ...
  @override
  String toString() {
    return 'ProfileState(profileModel: $profileModel, status: $status, error: $error)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, profileModel, status, error);
